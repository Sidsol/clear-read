"""
export_onnx_v2.py — Export V2 model to ONNX with INT8 quantization
...
def main():
    model_dir = Path(__file__).parent.parent / "output_v2" / "best_model"
    onnx_dir = Path(__file__).parent.parent / "output_v2" / "onnx"
    quantized_dir = Path(__file__).parent.parent / "output_v2" / "onnx_quantized"
    ...
    print("Exporting V2 model to ONNX...")
    main_export(
    ...
    print(f"\nTo deploy: copy {quantized_dir} to extension/public/model/onnx/")
